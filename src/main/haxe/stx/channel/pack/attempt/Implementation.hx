...
class Implementation{
  ...
  static public function errata<I,O,E,EE>(self:Attempt<I,O,E>,fn:Err<E>->Err<EE>):Attempt<I,O,EE>                   return _().errata(fn,self);

  static public function forward<I,O,E>(self:Arrowlet<I,Res<O,E>>,i:I):IO<O,E>                                      return _().forward(i,self);

  
  static public function attempt<I,O,Oi,E>(self:Attempt<I,O,E>,next:Arrowlet<O,Res<Oi,E>>):Attempt<I,Oi,E>          return _().attempt(next,self);
