...
class Implementation{
  ...
  static public function process<I,O,Oi,E>(self:Reframe<I,O,E>,that:Arrowlet<Couple<O,I>,Oi>):Channel<I,Oi,E>                 return Chnl.process(self,that);

  static public function prepare<I,O,E>(self:Reframe<I,O,E>,i:Res<I,E>,cont:Sink<Res<Couple<O,I>,E>>):Automation      return Arw.prepare(Arrowlet.lift(self.asRecallDef()),i,cont);
  static public function then<I,O,Oi,E>(self:Reframe<I,O,E>,that:Arrowlet<Res<Couple<O,I>,E>,Oi>):Arrowlet<Res<I,E>,Oi>                   return Arw.then(self,that);
  ...
  static public function rearrange<I,Ii,O,Oi,E>(self:Reframe<I,O,E>,that:O->Arrange<Ii,I,Oi,E>):Attempt<Couple<Ii,I>,Oi,E>    return _().rearrange(that,self);
