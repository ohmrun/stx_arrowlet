...
@:forward abstract Channel<I,O,E>(ChannelDef<I,O,E>) from ChannelDef<I,O,E> to ChannelDef<I,O,E>{
  ...
  static public function pure<I,O,E>(v:Res<O,E>):Channel<I,O,E>                                 return _().pure(v);

  static public function fromArrowlet<I,O,E>(self:Arrowlet<I,O>):Channel<I,O,E>                     return _().fromArrowlet(self);
  static public function fromAttempt<I,O,E>(self:Arrowlet<I,Res<O,E>>):Channel<I,O,E>           return _().fromAttempt(self);
  static public function fromResolve<I,O,E>(self:Arrowlet<Res<I,E>,O>):Channel<I,O,E>           return _().fromResolve(self);
  static public function fromRecover<I,E>(self:Arrowlet<Err<E>,I>):Channel<I,I,E>            return _().fromRecover(self);
  static public function fromCommand<I,E>(self:Arrowlet<I,Option<Err<E>>>):Channel<I,I,E>    return _().fromCommand(self);
  static public function fromProceed<O,E>(self:Arrowlet<Noise,Res<O,E>>):Channel<Noise,O,E>     return _().fromProceed(self);
