...
class Implementation{
  ...
  static public function prepare<I,O,E>(self:Channel<I,O,E>,i:Res<I,E>,cont:Sink<Res<O,E>>):Automation        return Arw.prepare(Arrowlet.lift(self.asRecallDef()),i,cont);
  ...
  static public function errata<I,O,E,EE>(self:Channel<I,O,E>,fn:Err<E>->Err<EE>):Channel<I,O,EE>       return _().errata(fn,self);
