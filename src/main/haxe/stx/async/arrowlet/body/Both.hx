...
import stx.async.arrowlet.head.data.Both in TBoth;

@:forward @:callable abstract Both<A,B,C,D>(Arrowlet<Tuple2<A,C>,Tuple2<B,D>>) from Arrowlet<Tuple2<A,C>,Tuple2<B,D>> to Arrowlet<Tuple2<A,C>,Tuple2<B,D>>{
