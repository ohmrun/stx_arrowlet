...
@:forward abstract Arrowlet<I,O>(ArrowletT<I,O>){
  ...
  @:deprecated
  public function withInput(i:I,cont:Continue<O>):Automation                      return this(__,cont,i); 
  public function prepare(i:I,cont:Continue<O>):Automation                        return this(__,cont,i); 
